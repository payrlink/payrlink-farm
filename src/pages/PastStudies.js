...
import { APIRequest, API_PAST_STUDY } from "../api";
...
export class PastStudies extends Component {
  constructor(props) {
    super(props);
    this.state = {
      studyData: [],
              ...
              >
                ...
                <Col span={12}>
                  <Breadcrumb style={{ float: "right" }}>
                    ...
                    <Breadcrumb.Item>Past Studies</Breadcrumb.Item>
                  </Breadcrumb>
                </Col>
              </Row>
...
export default connect(mapStateToProps)(PastStudies);
