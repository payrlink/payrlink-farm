...
import { APIRequest, API_CURRENT_STUDY } from "../api";
...
export class CurrentStudies extends Component {
  constructor(props) {
    super(props);
    this.state = {
      studyData: [],
              ...
              >
                ...
                <Col span={12}>
                  <Breadcrumb style={{ float: "right" }}>
                    ...
                    <Breadcrumb.Item>Current Studies</Breadcrumb.Item>
                  </Breadcrumb>
                </Col>
              </Row>
...
export default connect(mapStateToProps)(CurrentStudies);
