...
const options = [
    { value: '1', label: <div className="d-flex"><img src={ETH} height="20px" /><h6 className="pl-2 mb-0">ETH</h6></div> },
    { value: '2', label: <div className="d-flex"><img src={DAL} height="20px" /><h6 className="pl-2 mb-0">DAL</h6></div> },
    { value: '3', label: <div className="d-flex"><img src={BNC} height="20px" /><h6 className="pl-2 mb-0">BNC</h6></div> },
    { value: '4', label: <div className="d-flex"><img src={BTC} height="20px" /><h6 className="pl-2 mb-0">BTC</h6></div> },
  ];
...
function ContextAwareToggle({ children, eventKey,theme, callback }) {
    ...
    >
        {isCurrentEventKey ? <h6 className={`font-weight-bold ${!theme && 'text-white'}`}>Hide!<img src={UpArrow} className="ml-1" /></h6> : <h6 className={`font-weight-bold ${!theme && 'text-white'}`}>Detail!<img src={DownArrow} className="ml-1" /></h6>}
    </button>
    );
  }
...
const FarmCard = (props) => {
    ...
    return (
        <>
        {data.map((e, key) => ( 
                            <Col md="10" lg="6" xl="4" className="farm_card px-md-4 mb-5">
                                <div className="p-4 card_sec shadow border_radius">
                                    <div className="d-flex mb-4">
                                        <img src={e.icon} height="40" className="mr-3" />
                                        <div>
                                            <h5 className="mb-0 font-weight-bold">{e.name}</h5>
                                            <span class="badge badge-pill badge-primary">{e.multiply}x</span>
                                        </div>
                                    </div>
                                    ...
                                    <div className="bg_harvest border_radius p-3 font-weight-bold mb-4">
                                        ...
                                        <div className="d-flex justify-content-between">
                                            ...
                                            <Button size="sm" className="py-1 px-3 shadow border-0 bg_app_dark h-100 rounded" onClick={() => setShowHarvest(true)}><h6 className="mb-0">HARVEST</h6></Button>
                                        </div>
                                        <span className="text_app">{e.name}</span><span>{' '}STAKED</span>
                                    </div>
                                
                                    {props.connectedWallet === null ?
                                        <Button className="font-weight-bold w-100 bg_app_dark rounded border-0" onClick={() => setModalShow(true)}>UNLOCK WALLET</Button>
                                    :   <>
                                            <Button className="font-weight-bold w-100 bg_app_dark rounded border-0 mb-2" onClick={() => setShowDeposit(true)}>DEPOSIT</Button>
                                            <Button variant="outline-primary" className="font-weight-bold w-100 rounded app_border" onClick={() => setShowWidhdraw(true)}>WITHDRAW</Button>
                                        </>
                                    }
                            ...
                            <ConectWallet show={modalShow} onHide={() => setModalShow(false)} onChangeWallet={props.onChangeWallet} themeClass={props.themeClass} />
                            <Modal
                                ...
                                <Row className="justify-content-between px-4">
                                    ...
                                    <div className="px-4 deposit_card py-3 mt-3">
                                        ...
                                        <div className="mt-3 d-flex text-center align-items-center">
                                            ...
                                            <div className="px-2 w-50">
                                                <Button variant="outline-primary" className="font-weight-bold rounded w-100 app_border text-white px-4" onClick={() => setShowDeposit(false)}>Cancel</Button>
                                            </div>
                                        </div>
                                    </div>
                                </Modal.Body>
                                ...
                                <Row className="justify-content-between px-4">
                                    ...
                                    <div className="px-4 deposit_card py-3 mt-3">
                                        ...
                                        <div className="mt-3 d-flex text-center align-items-center">
                                            ...
                                            <div className="px-2 w-50">
                                                <Button variant="outline-primary" className="font-weight-bold rounded w-100 app_border text-white px-4" onClick={() => setShowWidhdraw(false)}>Cancel</Button>
                                            </div>
                                        </div>
                                    </div>
                                </Modal.Body>
                            ...
                            >
                                ...
                                <Row className="justify-content-between px-4">
                                    ...
                                    <div className="mt-3 d-flex text-center align-items-center">
                                            ...
                                            <div className="px-2 w-50">
                                                <Button variant="outline-primary" className="font-weight-bold rounded w-100 app_border h_title px-4" onClick={() => setShowHarvest(false)}>Cancel</Button>
                                            </div>
