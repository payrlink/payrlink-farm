    ...
    return (
      ...
      >
        ...
        <div className="d-flex">
            <img src={props.themeClass ? ExcMark : ExcMarkWhite} className="mr-3" />
            <p className="mb-0 ">
                You are about to input highly sensitive information, please 
                DO NOT expose to strangers.
            </p>
        </div>
        <div className="px-4">
        <Button variant="light" 
          className="mx-md-3 shadow d-flex align-items-center w-fill-available my-3 bg_harvest border-0" 
          onClick={()=>{props.onChangeWallet(1);props.onHide()}}><img src={props.themeClass ? Metamask : MetamaskDark} /><h3 className="text_app mb-0 ml-3">Metamask</h3></Button>
        <Button variant="light" 
          className="mx-md-3 shadow d-flex align-items-center w-fill-available mb-5 bg_harvest border-0" 
          onClick={()=>{props.onChangeWallet(2);props.onHide()}}><img src={props.themeClass ? WConnect : WConnectDark} /><h3 className="text_app mb-0 ml-3"> WalletConnect</h3></Button> 
        </div>
        </Modal.Body>
        {/* <Modal.Footer>
